...
const CollectorChat: React.FC = () => {
  ...
  const [isConnected, setIsConnected] = useState(() => socket?.isConnected || false)
    ...
    <div className="h-[calc(100vh-12rem)] flex flex-col">
            ...
            return (
              <div key={message.id}>
                ...
                {message.type === 'system' ? (
                  ...
                  <div className={`flex ${isOwnMessage(message.senderId) ? 'justify-end' : 'justify-start'}`}>
                    <div className={`max-w-xs lg:max-w-md ${
                      ...
                      <div className={`text-xs mt-1 ${
                        isOwnMessage(message.senderId) ? 'text-blue-100' : 'text-gray-500 dark:text-gray-400'
                      }`}>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-b-lg shadow p-4 border-t border-gray-200 dark:border-gray-700">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          ...
          <button
            onClick={() => setNewMessage('Running late, will arrive in 15 minutes')}
            className="px-3 py-1 text-xs bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
          >
            ⏰ Running Late
          </button>
